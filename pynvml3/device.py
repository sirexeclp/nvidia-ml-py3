...
class Device:
    ...
    def get_gpu_instance_profile_info(self, profile: GpuInstanceProfile):
        ...
        ret = fn(profile.as_c_type(), byref(c_info))
        return c_info
    ...
    def get_gpu_instance_possible_placements(self, profile: GpuInstanceProfile):
        ...
        gi_placement_array = GpuInstancePlacement * count.value
        c_gi_placement = gi_placement_array()

        self["GetGpuInstancePossiblePlacements_v2"](
            info.id, c_gi_placement, byref(count)
        )
